package com.naaisi.nursesite.injection.domain;
...
//		    DRUG VARCHAR(128) NOT NULL   COMMENT '药物名称' ,
...
//		) COMMENT = '注射药物 ';;
	...
	public String toString() {
		return "Injection [ID=" + ID + ", PATIENT_ID=" + PATIENT_ID + ", DRUG=" + DRUG + ", PRE_EXE_TIME="
