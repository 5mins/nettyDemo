...
public class DateTools {
	 ...
	 */
	//dateString "2011-05-09 11:49:45"
...
//		return ts;
//	}
	//dateString "1586611799"
	public final static java.sql.Timestamp string2Time(String dateString) {
		long t=315507660000L;//1980/1/1 1:1:0
		if (dateString.length()<11) {
			t = (Long.parseLong(dateString))*1000;
			
		}else {
			t = Long.parseLong(dateString);
	...
	/**
	 * method 将字符串类型的日期转换为一个Date（java.sql.Date） dateString 需要转换为Date的字符串 dataTime
	 * Date
	 */
	...
	public static void main(String[] args) {
		...
		// second,int nano)
		Timestamp tt = new Timestamp(Calendar.getInstance().get(Calendar.YEAR) - 1900,
